...
pub use self::query::{
    ...
    ReplaceSelectItem, RowsPerMatch, ScalarWithItem, Select, SelectFlavor, SelectInto, SelectItem,
    ...
    WildcardAdditionalOptions, With, WithFill, WithItem, XmlNamespaceDefinition,
